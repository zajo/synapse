...
Non-Intrusive Signal Programming Library for {CPP}-11 | Emil Dotchevski
ifndef::backend-pdf[]
:toc: left
:toclevels: 3
:toc-title:
...
[.text-right]
https://github.com/zajo/synapse[GitHub] | https://travis-ci.org/zajo/synapse[Travis] | https://ci.appveyor.com/project/zajo/synapse[AppVeyor] | link:./synapse.pdf[PDF]
endif::[]
...
* If two contexts share access to a C or {CPP} object, they can use that object as a rendezvous point, and communicate with each other through Synapse signals.
...
The source code is available in https://github.com/zajo/synapse[this GitHub repository].
...
See the link:https://travis-ci.org/zajo/synapse[Synapse Travis CI Builds].
