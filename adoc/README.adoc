...
* If two contexts share access to a C or {CPP} object, they can use that object as a rendezvouz point, and communicate with each other through Synapse signals.
...
[.text-right]
https://github.com/zajo/boost-synapse[GitHub] | <<tutorial>> | <<techniques>> | <<synopsis>> | <<reference>>
====
