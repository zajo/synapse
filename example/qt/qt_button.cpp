...
//synapse::meta::emitter. The connected lambda function responds to this meta signal
//by connecting (or disconnecting) the Qt-native QPushButton::clicked signal to the
//synapse::emit<button_clicked> function.
...
int main( int argc, char const * argv[ ] )
{
    ...
    synapse::connect<button_clicked>( pb, [&qd]() { qd.accept(); } );
