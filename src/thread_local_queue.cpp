    ...
    synapse
        ...
        synapse_detail
            ...
            posted_signals
                ...
                bool
                post( void const * e, args_binder_base const * args )
                    {
                    BOOST_SYNAPSE_ASSERT(e!=0);
                ...
                int
                emit_if_serial_number_matches( unsigned serial_number, thread_local_signal_data const & tlsd )
                    {
                    posted p;
                        {
                        std::lock_guard<std::mutex> lk(mut_);
            ...
            namespace
                ...
                cl_rec
                    ...
                    shared_ptr<thread_local_signal_data>
                    lock() const
                        {
            ...
            connection_list_list
                ...
                void
                notify_connection_list_created( shared_ptr<thread_local_signal_data> const & tlsd )
                    {
                    std::lock_guard<std::mutex> lk(mut_);
                ...
                int
                interthread_emit( void const * e, args_binder_base const * args )
                    {
                    BOOST_SYNAPSE_ASSERT(e!=0);
                    int count=0;
                    std::lock_guard<std::mutex> lk(mut_);
            ...
            namespace
                {
                shared_ptr<connection_list_list>
                create_connection_list_list()
                    {
                ...
                get_thread_local_connection_list_list()
                    {
            ...
            get_interthread_api()
                ...
                interthread_impl:
                    ...
                    int
                    emit( thread_local_signal_data const & tlsd, void const * e, args_binder_base const * args )
                        {
