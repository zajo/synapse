...
It is able to register connections and emit signals from any C or {CPP} object of any type whatsoever. If two contexts share access to a C or {CPP} object, they can use that object as a randezvouz point of sorts, and communicate with each other through Synapse signals.
